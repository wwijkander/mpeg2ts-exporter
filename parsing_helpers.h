...
/*
 * parse_udphdr_destination: parse the udp header and return the destination port of the udp payload
 */
static __always_inline int parse_udphdr_destination(struct hdr_cursor *nh,
					void *data_end,
					struct udphdr **udphdr)
{
	struct udphdr *h = nh->pos;
